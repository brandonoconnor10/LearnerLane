...
const StoppingYourVehiclesPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Stopping your vehicle');
...
export default StoppingYourVehiclesPage;