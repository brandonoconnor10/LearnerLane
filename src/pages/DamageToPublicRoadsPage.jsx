...
const DamageToPublicRoadsPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Damage to public roads');
  ...
  return (
    ...
    >
      <VerticalLineContainer className="flex flex-col items-center mt-32">
        ...
        <StyledButton
          to="/damage-to-public-roads/quiz"
          asLink
          variant="large"
...
export default DamageToPublicRoadsPage;
