...
const LocationSignSymbolsPage = () => {
  const { content, loading, error } = useK53Data('Road Signs', 'Location Sign Symbol');
    ...
    const loadImages = async () => {
      try {
        const result = await fetchData(
          'Section', '"Road Signs"',
          'Subsection', '"Location Sign Symbols"',
          100,
...
export default LocationSignSymbolsPage;