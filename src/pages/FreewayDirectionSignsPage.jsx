...
const FreewayDirectionSignsPage = () => {
  const { content, loading, error } = useK53Data('Road Signs', 'Freeway Direction Sign');
    ...
    const loadImages = async () => {
      try {
        const result = await fetchData(
          'Section', '"Road Signs"',
          'Subsection', '"Freeway Direction Signs"',
          100,
    ...
    >
      <VerticalLineContainer className="mt-6">
        ...
        <div className="relative flex flex-col items-center z-10">
          <StyledButton
            to="/freeway-direction-signs/quiz"
            asLink
            variant="large"
            className="my-6"
          >
...
export default FreewayDirectionSignsPage;