...
export default function WarningSignCombinationsPage() {
  const { content, loading, error } = useK53Data('Road Signs', 'Warning Sign Combination');
    ...
    const loadImages = async () => {
      try {
        const result = await fetchData(
          'Section', '"Road Signs"',
          'Subsection', '"Warning Sign Combinations"',
          100,
    ...
    >
      <VerticalLineContainer className="mt-6">
        ...
        <div className="relative flex flex-col items-center z-10">
          <StyledButton
            to="/warning-sign-combinations-signs/quiz"
            asLink
            variant="large"
            className="my-6"
          >
