...
const TemporarySignCombinationsPage = () => {
  const { content, loading, error } = useK53Data('Road Signs', 'Temporary Sign Combination');
    ...
    const loadImages = async () => {
      try {
        const result = await fetchData(
          'Section', '"Road Signs"',
          'Subsection', '"Temporary Sign Combinations"',
          100,
    ...
    >
      <VerticalLineContainer className="mt-6">
        ...
        <div className="relative flex flex-col items-center z-10">
          <StyledButton
            to="/temporary-sign-combinations/quiz"
            asLink
            variant="large"
            className="my-6"
          >
...
export default TemporarySignCombinationsPage;