...
const FreewayAllowedStopsPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Freeway Allowed Stops');
...
export default FreewayAllowedStopsPage;
