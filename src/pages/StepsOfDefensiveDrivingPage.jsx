...
const StepsOfDefensiveDrivingPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Defensive driving involves 4 steps');
    ...
    <PageLayout
      subtitle={
        <h2 className="text-2xl md:text-3xl font-semibold text-cyan font-rajdhani mt-4">
          Defensive driving involves 4 steps
        </h2>
      }
...
export default StepsOfDefensiveDrivingPage;