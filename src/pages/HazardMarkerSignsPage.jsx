...
const HazardMarkerSignsPage = () => {
  const { content, loading, error } = useK53Data('Road Signs', 'Hazard Marker Sign');
    ...
    const loadImages = async () => {
      try {
        const result = await fetchData(
          'Section', '"Road Signs"',
          'Subsection', '"Hazard Marker Signs"',
          100,
...
export default HazardMarkerSignsPage;