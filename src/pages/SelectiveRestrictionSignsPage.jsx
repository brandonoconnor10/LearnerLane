...
const SelectiveRestrictionSignsPage = () => {
  const { content, loading, error } = useK53Data('Road Signs', 'Selective Restriction Sign');
    ...
    const loadImages = async () => {
      try {
        const result = await fetchData(
          'Section', '"Road Signs"',
          'Subsection', '"Selective Restriction Signs"',
          100,
    ...
    >
      <VerticalLineContainer className="mt-6">
        ...
        <div className="relative flex flex-col items-center z-10">
          <StyledButton
            to="/selective-restriction-signs/quiz"
            asLink
            variant="large"
            className="my-6"
          >
...
export default SelectiveRestrictionSignsPage;