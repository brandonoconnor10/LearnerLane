...
const DrivingOnTheShoulderOfTheRoadPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Driving on the shoulder of the road');
  ...
  return (
    <PageLayout
      subtitle={
        <h2 className="text-2xl md:text-3xl font-semibold text-cyan font-rajdhani mt-4">
          Driving On The Shoulder Of The Road Page
        </h2>
      }
    ...
    >
      <VerticalLineContainer className="flex flex-col items-center mt-32 px-4 max-w-3xl mx-auto w-full">
        ...
        <StyledButton
          to="/driving-on-the-shoulder-of-the-road/quiz"
          asLink
          variant="large"
...
export default DrivingOnTheShoulderOfTheRoadPage;