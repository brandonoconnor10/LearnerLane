...
const ActionsGroupedPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Actions Grouped');
...
export default ActionsGroupedPage;
