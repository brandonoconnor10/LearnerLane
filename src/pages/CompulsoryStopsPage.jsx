...
const CompulsoryStopsPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Compulsory Stops');
...
export default CompulsoryStopsPage;