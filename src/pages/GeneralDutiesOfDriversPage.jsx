...
const GeneralDutiesOfDriversPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'General Duties of drivers and passengers');
...
export default GeneralDutiesOfDriversPage;
