...
const CarryingALoadPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Carrying a load');
...
export default CarryingALoadPage;
