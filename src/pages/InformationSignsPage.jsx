...
const InformationSignsPage = () => {
  const { content, loading, error } = useK53Data('Road Signs', 'Information Sign');
...
export default InformationSignsPage;