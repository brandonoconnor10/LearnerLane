...
const DutiesOfMotorcyclesPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Duties relating to motorcycles, tricycles and quad-bikes');
  ...
  return (
    ...
    >
      <VerticalLineContainer className="flex flex-col items-center mt-32">
        ...
        <StyledButton
          to="/duties-relating-to-motorcycles/quiz"
          asLink
          variant="large"
...
export default DutiesOfMotorcyclesPage;
