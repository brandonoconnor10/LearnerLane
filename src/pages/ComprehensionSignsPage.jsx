...
const ComprehensionSignsPage = () => {
  const { content, loading, error } = useK53Data('Road Signs', 'Comprehension Sign');
    ...
    const loadImages = async () => {
      try {
        const result = await fetchData(
          'Section', '"Road Signs"',
          'Subsection', '"Comprehension Signs"',
          100,
...
export default ComprehensionSignsPage;