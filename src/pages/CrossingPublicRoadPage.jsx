...
const CrossingPublicRoadPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Cross or entering a public road or traffic lane');
...
export default CrossingPublicRoadPage;
