...
const DiagrammaticSignSymbolsPage = () => {
  const { content, loading, error } = useK53Data('Road Signs', 'Diagrammatic Sign Symbol');
    ...
    const loadImages = async () => {
      try {
        const result = await fetchData(
          'Section', '"Road Signs"',
          'Subsection', '"Diagrammatic Sign Symbols"',
          100,
    ...
    >
      <VerticalLineContainer className="mt-6">
        ...
        <div className="relative flex flex-col items-center z-10">
          <StyledButton
            to="/diagrammatic-sign-symbols/quiz"
            asLink
            variant="large"
            className="my-6"
          >
...
export default DiagrammaticSignSymbolsPage;