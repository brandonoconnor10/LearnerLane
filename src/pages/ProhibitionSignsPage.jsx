...
const ProhibitionSignsPage = () => {
  const { content, loading, error } = useK53Data('Road Signs', 'Prohibition Sign');
...
export default ProhibitionSignsPage;