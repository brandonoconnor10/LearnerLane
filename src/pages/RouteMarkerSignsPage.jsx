...
const RouteMarkerSignsPage = () => {
  const { content, loading, error } = useK53Data('Road Signs', 'Route Marker Sign');
...
export default RouteMarkerSignsPage;