...
const PedestrianCrossingPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Pedestrian crossing');
...
export default PedestrianCrossingPage;
