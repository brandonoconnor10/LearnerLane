...
const AbandonedVehiclesPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Abandoned vehicles on public roads');
...
export default AbandonedVehiclesPage;
