...
const ImportantRulesPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Important Rules');
...
export default ImportantRulesPage;