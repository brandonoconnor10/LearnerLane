...
const SafetyMarkingsPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Safety Markings');
...
export default SafetyMarkingsPage;
