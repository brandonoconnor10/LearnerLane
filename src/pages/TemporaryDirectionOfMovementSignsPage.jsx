...
const TemporaryDirectionOfMovementSignsPage = () => {
  const { content, loading, error } = useK53Data('Road Signs', 'Temporary Direction of Movement Sign');
    ...
    const loadImages = async () => {
      try {
        const result = await fetchData(
          'Section', '"Road Signs"',
          'Subsection', '"Temporary Direction of Movement Signs"',
          100,
    ...
    >
      <VerticalLineContainer className="mt-6">
        ...
        <div className="relative flex flex-col items-center z-10">
          <StyledButton
            to="/temporary-direction-of-movement-signs/quiz"
            asLink
            variant="large"
            className="my-6"
          >
...
export default TemporaryDirectionOfMovementSignsPage;
