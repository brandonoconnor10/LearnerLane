...
const HinderingTrafficPage = () => {
  const { content, loading, error } = useK53Data('Rules Of The Road', 'Hindering or obstructing traffic on a public road');
  ...
  return (
    ...
    >
      <VerticalLineContainer className="flex flex-col items-center mt-32">
        ...
        <StyledButton
          to="/hindering-or-obstructing-traffic-on-a-public-road/quiz"
          asLink
          variant="large"
...
export default HinderingTrafficPage;
